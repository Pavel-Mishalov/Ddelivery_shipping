  ...
  update_checkout_action:function(c){
    ...
    jQuery.post(
      ...
      function(res){
        ...
        if( res.length == 0 ){
          jQuery.post( "\/wp-admin\/admin-ajax.php", {action: 'mis_empty_point'}, function(){ alert('Просим прошения. Для Вашего заказа нет точек продаж  ' + res); jQuery('body').trigger('update_checkout'); });
        }else{
          console.log(res);
         ...
         MyBalloonLayout = ymaps.templateLayoutFactory.createClass(
            ...
            MyBalloonContentLayout = ymaps.templateLayoutFactory.createClass(
              '<table class="shop-setting">'+
                ...
                '</tr>'+
                '<tr>'+
                  '<td class="mis-pickup-cost" colspan="2"><div class="btn-price"><p class="pickup-price">{{properties.price}}<span class="woocommerce-Price-currencySymbol">₴</span></p><button class="mis-btn" onclick="get_point({{properties.price}});">Заберу здесь</button></td>'+
                '</tr>'+
              '</table>'
            )
